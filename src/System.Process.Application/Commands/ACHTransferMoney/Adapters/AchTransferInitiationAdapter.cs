...
{
    public class AchTransferInitiationAdapter : IAdapter<TransferInitiationParams, AchTransferMoneyRequest>
    {
        #region Properties
        ...
        #region Constructor
        public AchTransferInitiationAdapter(ProcessConfig ProcessConfig)
        {
        ...
        public TransferInitiationParams Adapt(AchTransferMoneyRequest input)
        {
            return new TransferInitiationParams
            {

                ReceiverName = input.AccountTo.Name,
                ...
                SenderTransactionBankAccountNumber = input.AccountFrom.AccountId,
                SenderAccountType = input.AccountFrom.AccountType,
                SenderBankRoutingNumber = input.AccountFrom.RoutingNumber,
                
                ReceiverTransactionBankAccountNumber = input.AccountTo.AccountId,
                ReceiverAccountType = input.AccountTo.AccountType,
                ReceiverBankRoutingNumber = input.AccountTo.RoutingNumber,

                PaymentType = ProcessConfig.TransferConfig.AchPaymentType,
                PaymentSubType = input.NextDay,
                Direction = ProcessConfig.TransferConfig.AchDirection,
                ...
                CoreTransactionDebitCode = ProcessConfig.AchDebitTransactionCodeCode,
                CoreTransactionCreditCode = ProcessConfig.AchCreditTransactionCodeCode, 
