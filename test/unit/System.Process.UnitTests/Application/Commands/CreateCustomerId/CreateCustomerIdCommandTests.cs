...
namespace System.Process.UnitTests.Application.Commands.CreateCustomerId
{
    public class CreateCustomerIdCommandTests
    {
        ...
        public async Task ShouldSendHandleCreateCustomerIdAsync()
        {
            ...
            var notification = ProcessUnitTestsConfiguration.ReadJson<CreateCustomerIdNotification>("CreateCustomerIdNotification.json");
