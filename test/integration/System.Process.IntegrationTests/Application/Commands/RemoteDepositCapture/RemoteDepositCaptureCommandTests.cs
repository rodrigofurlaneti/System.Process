...
namespace System.Process.IntegrationTests.Application.Commands.RemoteDepositCapture
{
    public class RemoteDepositCaptureCommandTests
    {
        ...
        public RemoteDepositCaptureCommandTests()
        {
            ...
            TransferInitiationClient.Setup(x => 
            x.TransferInitiation(It.IsAny<TransferInitiationParams>(), It.IsAny<string>(), It.IsAny<CancellationToken>())).Returns(Task.FromResult(GetTransferInitiationResult()));
